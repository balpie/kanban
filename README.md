...
- Per compilare la documentazione fare `make doc`. Dipende da `pandoc` e un latex engine.  
...
I comandi disponibili per `utente` sono i seguenti:  
    ...
    - `card_done`: comunica alla lavagna che ha finito l'ultima card che gli è arrivata  
